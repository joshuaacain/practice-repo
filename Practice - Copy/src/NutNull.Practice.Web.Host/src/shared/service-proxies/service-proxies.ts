...
export class ProductCategoryServiceProxy {
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditProductCategoryDto | undefined): Observable<string> {
     ...
     * @return Success
     */
    getProductCategory(id: string | undefined): Observable<CreateOrEditProductCategoryDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreateOrEditProductCategoryDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreateOrEditProductCategoryDto>;
        }));
    }

    protected processGetProductCategory(response: HttpResponseBase): Observable<CreateOrEditProductCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreateOrEditProductCategoryDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getAll(): Observable<CreateOrEditProductCategoryDto[]> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<CreateOrEditProductCategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(CreateOrEditProductCategoryDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
