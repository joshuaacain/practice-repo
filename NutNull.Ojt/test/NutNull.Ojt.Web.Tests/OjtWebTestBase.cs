...
using NutNull.Ojt.Models.TokenAuth;
...
{
    public abstract class OjtWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OjtWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OjtWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OjtDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OjtDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OjtDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OjtDbContext, Task<T>> func)
        {
            T result;
